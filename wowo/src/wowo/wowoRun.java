...
public class wowoRun {
	public static void main(String[] args) throws IOException {
		...
		//producaoLista3K.setProperty("a", "um-uma");
		//producaoLista3K.setProperty("abandon", "abandonar");
		//producaoLista3K.setProperty("furniture", "mobília");
		//producaoLista3K.setProperty("funding", "financiamento");
		//producaoLista3K.setProperty("fund", "financiar");
		//producaoLista3K.setProperty("fully", "completamente");
		//producaoLista3K.setProperty("full", "completo");
		//producaoLista3K.setProperty("front", "frontal");
		//producaoLista3K.setProperty("fresh", "fresco");
		//producaoLista3K.setProperty("framework", "estrutura");
		//producaoLista3K.setProperty("frame", "estrutura");
		//producaoLista3K.setProperty("founder", "fundador");
		//producaoLista3K.setProperty("forward", "adiante");
		//producaoLista3K.setProperty("forth", "adiante");
